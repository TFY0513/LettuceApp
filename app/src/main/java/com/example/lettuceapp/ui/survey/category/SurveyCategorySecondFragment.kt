...
class SurveyCategorySecondFragment : Fragment() {
    private var _binding: FragmentSurveyCategorySecondBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSurveyCategorySecondBinding.inflate(inflater, container, false)
